...
guardiao-sobrio-app    → este repo
 ├── apps/mobile/       (Expo + RN)
 ├── apps/web/          (Next.js landing/PWA)
 ├── packages/          (design-tokens, types compartilhados)
 ├── design/            (protótipo HTML — referência viva)
 ├── ROADMAP.md         (este arquivo)
 └── README.md          (→ linka guardiao-sobrio-docs)
```

---

## FASE 0 — Preparação · Semanas 1–2
**Meta:** ambiente pronto + design system validado.
...
- [ ] Landing (Next.js) publicada na Vercel
- **DoD:** app aprovado nas lojas; landing com link de download.

---

## FASE 2 — Crescimento · Semanas 9–16
**Meta:** ativar monetização e aprofundar o método.
